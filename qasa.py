...
from models.pairwise_model import FixedAttendNeuralScoreRanker
from utils import Timer
from dataset import QuasarTDataset, get_trimmed_embeddings
from constants import DATA


class QuasarModel(FixedAttendNeuralScoreRanker):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train new models/Evaluate pre-trained models.')
